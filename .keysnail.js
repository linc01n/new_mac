...
key.setEditKey('C-M-y', function (ev) {
                ...
                if (!command.kill.ring.length || ct != command.kill.ring[0]){ command.pushKillRing(ct);}
...
plugins.options["kkk.sites"] = ["^https?://([0-9a-zA-Z]+\\.)?github\\.com/", "^https?://([0-9a-zA-Z]+\\.)?google\\.com*/"];
